...
pz_mat4
pz_mat4_mul(pz_mat4 a, pz_mat4 b)
{
    pz_mat4 r = { 0 };
...
pz_vec4
pz_mat4_mul_vec4(pz_mat4 m, pz_vec4 v)
{
    return (
        pz_vec4) { m.m[0] * v.x + m.m[4] * v.y + m.m[8] * v.z + m.m[12] * v.w,
...
pz_mat4
pz_mat4_perspective(float fov, float aspect, float near, float far)
{
...
pz_mat4
pz_mat4_look_at(pz_vec3 eye, pz_vec3 target, pz_vec3 up)
{
